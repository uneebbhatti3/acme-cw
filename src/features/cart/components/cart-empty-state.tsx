  ...
  return (
    <>
      <div className="py-16 text-center">
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-slate-100"><ShoppingBag className="h-9 w-9 text-slate-300" /></div>
        <h2 className="mt-6 text-2xl font-semibold tracking-tight text-slate-950">Your cart is empty</h2>
        <p className="mx-auto mt-3 max-w-md text-sm leading-7 text-slate-500">Add instruments from the catalog to build an inquiry list. Send it to our sales team for a tailored quotation.</p>
      ...
      <div className="mt-4 border-t border-slate-200 pt-16">
        ...
        <h2 className="mt-4 text-3xl font-semibold tracking-tighter text-slate-950">Popular with buyers</h2>
